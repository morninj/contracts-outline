...
\begin{enumerate}
    \item Implied contracts aren't really contracts. There's no offer, 
    acceptance, or assent. But to prevent unjust enrichment, someone should be 
    rewarded.
    \item ``\textbf{Contracts implied in law}, or as they are more commonly 
    called `quasi contracts,' are obligations imposed by law on grounds of 
    justice and equity. Their purpose is to \textbf{prevent unjust 
    enrichment}. Unlike express contracts or contracts implied in fact, quasi 
    contracts do not rest upon the assent of the contracting 
    parties.''\footnote{Casebook p.  505.}
    \begin{enumerate}
