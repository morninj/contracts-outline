...
\begin{enumerate}
    ...
    the contract without liability.''\footnote{Casebook p. 381.} \emph{Colfax 
    Envelope Corp. v. Local No. 458-3M}.
    \end{enumerate}
    ...
    \item \textbf{Trade quantities} can vary if the usage is customary within 
    the trade---e.g., 4,000 shingles can really mean 2,500. \emph{Hurst v. 
    W.J. Lake \& Co.}
\end{enumerate}
...
\begin{enumerate}
    \item % TODO
    \item % TODO key concepts: intent, clarity, revocation
\end{enumerate}
