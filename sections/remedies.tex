...
\begin{enumerate}
    ...
    \end{enumerate}
    \item The trial court dismissed, holding that Berkley was entitled as a 
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \end{enumerate}
        \item Example: A hires B to build a \$500,000 house. A hasn’t paid 
        anything. B stops halfway through. B did \$200,000 worth of work. 
        It will cost \$300,000 to finish the job.
        \begin{enumerate}
            \item B owes A the cost of completion (\$300,000) - (original 
            contract price (\$500,000) - amount already paid (\$0)) = 
            -\$200,000---i.e., A owes B \$200,000.
        \end{enumerate}
    \end{enumerate}
\end{enumerate}

\paragraph{Diminution in Value: \emph{Peevyhouse v. Garland Coal \& Mining 
Co.}}
...
\paragraph{``Pleasure and Amenity'' Damages: \emph{Ruxley Electronics \& 
...
\begin{enumerate}
    \item Certainty applies in two ways:
    \begin{enumerate}
        \item \textbf{Causation}: it must be certain that the breach caused 
        the loss.
        \item \textbf{Amount}: to be compensable, the amount of loss must be 
        certain.
    \end{enumerate}
\end{enumerate}
...
~\\\\
Courts will generally not order specific performance when money damages are 
adequate (\emph{but see} \emph{Walgreen} below).
...
~\\\\
When there are no measurable expectation damages, reliance damages may be the 
...
% TODO google group with case name
\begin{enumerate}
...
\paragraph{Recovery for the Breaching Party: \emph{Kutzin v. Pirnie}}
~\\\\
